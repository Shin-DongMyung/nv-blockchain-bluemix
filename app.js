...
var options = 	{
					...
					chaincode:{
						zip_url: 'https://github.com/Shin-DongMyung/nv-chaincode-local/archive/master.zip',
						unzip_dir: 'nv-chaincode-local-master',									//subdirectroy name of chaincode after unzipped
						git_url: 'https://github.com/Shin-DongMyung/nv-chaincode-local',			//GO git http url
